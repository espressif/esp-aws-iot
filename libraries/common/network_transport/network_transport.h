...
/*
 * transport_interface.h (from coreMQTT/coreHTTP) forwards NetworkContext and
 * typedefs NetworkContext_t. When building this component alone that header is
 * not on the include path, so provide the typedef here instead.
 */
